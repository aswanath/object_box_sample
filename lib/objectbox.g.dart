...
import 'domain/object_box/person_model.dart';
...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 1),
      name: 'Person',
      lastPropertyId: const IdUid(4, 8751731581833819839),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 6743152530274613903),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 3171109616427914033),
            name: 'name',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 2534242584071114978),
            name: 'place',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      ...
      retiredPropertyUids: const [8751731581833819839],
  ...
  final bindings = <Type, EntityDefinition>{
    Person: EntityDefinition<Person>(
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          final object = Person(
              place: const fb.StringReader(asciiOptimization: true)
...
class Person_ {
  ...
  /// see [Person.place]
  static final place = QueryStringProperty<Person>(_entities[0].properties[2]);
}
